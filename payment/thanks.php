...
<head>
    ...
    <!-- <meta http-equiv="refresh" content="2; url=https://wrapandwow.com"> -->
     <title>WrapAndWow || Thank You</title>
    <meta name="description" content="Thank You | Payment" />
    <meta name="author" content="WrapAndWow" />
...
<body class="gray-bg">
    ...
    <img src="img/success.png" height="60">
        <h2>Thanks, for your patronage...!</h2>

        <div class="error-desc">
        <a href="../" class="btn btn-primary m-t">Back to Homepage</a>
