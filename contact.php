    ...
    <header>
        ...
        <div class="header-top">
            <div class="container">
              ...
              <span><a href="https://twiter.com/fearnot36"><i class="fab fa-twitter"></i></a></span>
              <span><a href="https://www.facebook.com/itz facebook"><i class="fab fa-facebook-f"></i></a></span>
              <span><a href="https://www.instagram.com.fearnot36"><i class="fab fa-instagram"></i></a></span>
            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container position-relative">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-3">
                        <div class="logo">
                            <a href="index.php"> <img src="assets/images/logo/honestylogo.png" alt="logo"></a>
                        </div>
                    </div>
                    <div class="col-lg-6 d-none d-lg-block">
                        <nav id="mobile-menu">
                            <ul class="main-menu">
                                <li><a href="index.php">home <span><i class="fas fa-angle-down"></i></span></a>
                                    <!-- <ul class="submenu">
                ...
                <div class="col-lg-6 col-md-12  wow fadeInUp">
                    <div class="about-left">
                        <div class="about-l-shapes">
                            <!-- <span class="als-1"><img src="imgs/bc.jpg" alt=""></span> -->
                        </div>
                        <div class="row">
                            <!-- <div
...
error_reporting(E_ALL);
                       ...
                       if(isset($_REQUEST["submit"])){
                        $order_uin=$_REQUEST["order_uin"];
                        $name=$_REQUEST["name"];
                        $email= $_REQUEST["email"];
                        $msg= $_REQUEST["msg"];


                        $sql="INSERT INTO msg (order_uin, name, email, `status`, msg) VALUES ('$order_uin','$name','$email ','pending','$msg')";
                        ...
                        echo "<script>alert('Thanks your complaint has been noted, We will reach out to you soon ')</script>"; 
                    
                    }
?>
                            <input type="text" name="order_uin" placeholder="Transaction Reference:">
                            <input type="text" name="name" placeholder="your name:">
                            <input type="email" name="email" placeholder="email">
                            <!-- <input type="url" placeholder="website"> -->
                            <textarea placeholder="write your text" name="msg"></textarea>
                            <button type="submit" name="submit" class="btn">send a message</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 wow fadeInUp" data-wow-delay=".4s">
                    <div
                        ...
                        <div class="info-content text-center text-lg-left">
                            <h5>Get Direction</h5>
                            <p>Ado junction, owo express way Akure Ondo state</p>
                        </div>
                    </div>
                </div>
    ...
    <footer class="padding-top-40 padding-bottom-40">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between padding-bottom-25">
                    <div class="col-lg-3 col-md-3">
                        <div class="f-logo">
                            <a href="index.php"> <img src="assets/images/logo/honestylogo.png" alt=""></a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 margin-bottom-20">
                        <div class="widget">
                            <h6>opening hours</h6>
                            <p><span>monday-friday: 8am - 9pm</span>
                                <br><span>saturday: 9am - 6pm</span>
                            </p>
        ...
        <div class="copyright-area text-center">
            <p>Copyright © 2024 <a href="index.php">Fearnot</a></p>
        </div>
    </footer>
